...
class AbstractDartsPointController : public AbstractDartsController
{
    Q_OBJECT
public slots:
...
signals:
    ...
    void hideDartsPoint(const QUuid &tournament, const QUuid &player, const int &roundIndex, const int &throwIndex);
    void revealDartsPoint(const QUuid &tournament, const QUuid &player, const int &roundIndex, const int &throwIndex);
