...
class JsonArrayFromPlayerNamesAndIds :
        public IBinaryService<const QVector<QUuid>&,const QVector<QString>&, QJsonArray>
{
public:
    QJsonArray service(const QVector<QUuid>& playerIds, const QVector<QString>& playerNames) override
    {
