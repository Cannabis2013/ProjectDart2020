...
const IDartsPointIndexes *DartsSingleAttemptIndexesBuilder::buildIndexes(const QVector<const IPlayerInput *> &orderedModels,
...
const IDartsPointIndexes *DartsSingleAttemptIndexesBuilder::assembleDartsIndexesByModels(const QVector<const IPlayerInput *> &orderedModels,
