...
Rectangle {
    ...
    onLabelBackgroundColorChanged: titleLabel.color = labelBackgroundColor

    property string title: ""
    onTitleChanged: titleLabel.text = title

    property int titleFontSize: 10
    onTitleFontSizeChanged: titleLabel.fontSize = titleFontSize

    property color titleFontColor: "black"
    onTitleFontColorChanged: titleLabel.fontColor = titleFontColor
