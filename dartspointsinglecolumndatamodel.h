#ifndef DARTSPOINTSINGLECOLUMNDATAMODEL_H
#define DARTSPOINTSINGLECOLUMNDATAMODEL_H
...
namespace DartsDataModelsContext {
    class DartsPointSingleColumnDataModel : public QAbstractTableModel
    {
        Q_OBJECT
    public:
        // Public types
        ...
        // Data related
        Q_INVOKABLE bool insertData(const QString &playerName, const int &point,
                                    const int &score);
        ...
        bool setDataAtIndex(const QModelIndex &index, const IDataModelPoint* &pointModel);
    signals:
    ...
    protected:
         ...
         * Services
         */
        IDartsDataModelPointBuilder *_pointModelBuilderService;
        IConvertPointToJson *_convertPointToJsonService;
    private:
        // Data related
        ...
        void initializeFieldsHorizontally(const int& startColumn);
         ...
         * Scores
         */
        QVector<const IDataModelPoint*> _data;
    };
}

#endif // DARTSPOINTSINGLECOLUMNDATAMODEL_H
