...
/*
 * A method is described as 'exposed' if it's callable from any QML context
 */

class DartsTableModel : public DartsTableServices
{
    Q_OBJECT
public:
    // Constructor
    ...
    Q_INVOKABLE bool insertData(const int &row, const int &point, const int &score);
