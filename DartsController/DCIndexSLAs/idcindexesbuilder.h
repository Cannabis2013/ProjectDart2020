...
{
public:
    virtual const DCContext::IDCIndexes* buildIndexes(const QByteArray& json) const = 0;
    virtual const DCContext::IDCIndexes* buildIndexes(const IDCIndexService* service) const = 0;
};
