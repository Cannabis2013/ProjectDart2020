...
public:
    ...
    const DartsScoresContext::DartsScore *assembleDartsScoreByJson(const QByteArray &json) const override;
    QVector<const DartsScoresContext::DartsScore *> assembleDartsScoresByJson(const QByteArray &json) const override;
