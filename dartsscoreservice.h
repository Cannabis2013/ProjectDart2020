...
<<<<<<< Updated upstream:dartsscorecontroller.h
class DartsScoreController : public ScoreControllerInterface
=======
class DartsScoreService : public ScoreControllerInterface
>>>>>>> Stashed changes:dartsscoreservice.h
{
public:
...
=======
    static DartsScoreService* createInstance(const int& initialScore,
>>>>>>> Stashed changes:dartsscoreservice.h
                                              const QUuid &winner);
...
=======
    DartsScoreService(const int& initialScore,
>>>>>>> Stashed changes:dartsscoreservice.h
                       const QUuid& winner);
