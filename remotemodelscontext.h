...
public:
    ...
    void createAssignedPlayerEntities(const QUuid &) override;
    void createAssignedPlayerPoints(const QUuid &) override;
    void createDartsTournamentWinnerIdAndName(const QUuid &) override;
    void createAssignedPlayerScores(const QUuid &) override;
    void createDartsScoreIndexes(const QUuid &tournament) override;
