...
<<<<<<< Updated upstream:itournamentmodelscontext.h
...
=======
template<typename TDartsTournament, typename TDartsScore>
class IDartsTournamentService
{
public:
    virtual ~IDartsTournamentService()= default;
>>>>>>> Stashed changes:idartstournamentservice.h
    /*
     * Tournament related section
     */
    virtual QUuid addDartsTournamentToDb(const TDartsTournament*) = 0;
...
=======
    virtual void addDartsScoreModelToDb(const TDartsScore* dartsScoreModel) = 0;
>>>>>>> Stashed changes:idartstournamentservice.h
