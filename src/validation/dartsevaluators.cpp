...
#include "src/validation/dartsbeginnervalidator.h"
#include "src/validation/dartsmediumvalidator.h"
#include "src/validation/dartsprofessionalevaluator.h"
...
AbstractDartsEvaluator* DartsEvaluators::fromMode()
{
    if (_mode == 0)
        ...
        return new DartsMediumValidator(_services);
    return nullptr;
}
