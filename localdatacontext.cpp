                                 ...
                                 const int &point)
{
    ...
    try {
        ...
        emit sendPlayerScore(player,totalScore);
        return pointID;
...
int LocalDataContext::score(const QUuid &tournament, const QUuid &player) const
{
...
int LocalDataContext::score(const QUuid &player) const
{

}


QUuid LocalDataContext::createPlayer(const QString &firstName, const QString &lastName, const QString &playerEMail, const int &role)
{
}

void LocalDataContext::deletePlayerByFirstName(const QString &firstName)
{
}

void LocalDataContext::deletePlayerByID(const QUuid &player)
{
}

void LocalDataContext::deletePlayerByEmail(const QString &playerEMail)
{
}

QUuid LocalDataContext::playerIDFromFullName(const QString &fullName) const
{
}

QUuid LocalDataContext::playerIDFromIndex(const int &index) const
{
}

QString LocalDataContext::playerFirstName(const QUuid &id) const
{
}

QString LocalDataContext::playerLastName(const QUuid &id) const
{
}

QString LocalDataContext::playerFullName(const QUuid &id) const
{
}

QString LocalDataContext::playerEMail(const QUuid &id) const
{
}

QList<QUuid> LocalDataContext::players() const
{
}

int LocalDataContext::playersCount() const
{
}

IDataContext<QUuid, QList<QUuid>, QString, ITournamentBuilder, DefaultPlayerBuilder> *LocalDataContext::setPlayerBuilder(DefaultPlayerBuilder *builder)
{
}

DefaultPlayerBuilder *LocalDataContext::playerBuilder() const
{
}
